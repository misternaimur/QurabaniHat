      ...
      <div className="min-h-[calc(100vh-80px)] bg-[#f8f9fa] flex flex-col items-center justify-center relative overflow-hidden font-inter">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center">
          ...
          <div className="relative flex items-center justify-center mb-6">
            ...
            <span className="material-symbols-outlined absolute text-3xl text-[#0f4d30] animate-pulse">
              grid_view
            </span>
          </div>
          ...
          <p className="text-gray-500 text-sm mt-2 animate-pulse delay-75">
        ...
        <div className="w-full md:w-72 shrink-0 flex flex-col gap-6">
          <div className="bg-white rounded-xl p-4 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100">
            <nav className="flex flex-col gap-1">
              <a
                href="#"
                className="flex items-center gap-3 px-4 py-3.5 bg-[#0f4d30] text-white rounded-lg font-medium shadow-md shadow-[#0f4d30]/20"
              >
              ...
              <a
                href="#"
                className="flex items-center gap-3 px-4 py-3.5 text-gray-600 hover:bg-gray-50 rounded-lg font-medium transition-colors"
              >
                <span className="material-symbols-outlined text-[22px]">
                  receipt_long
                </span>
              ...
              <a
                href="#"
                className="flex items-center gap-3 px-4 py-3.5 text-red-500 hover:bg-red-50 rounded-lg font-medium transition-colors"
              >
                <span className="material-symbols-outlined text-[22px]">
                  logout
                </span>
          ...
          <div className="bg-[#114b30] rounded-xl p-6 text-white relative overflow-hidden shadow-xl shadow-[#114b30]/20">
            {/* Star watermark */}
            <span className="material-symbols-outlined absolute -right-8 -top-8 text-[140px] opacity-[0.08] rotate-12">
              star
            </span>
            ...
            <p className="text-emerald-100/90 text-sm mb-5 relative z-10 leading-relaxed">
              Upgrade to early access for the highest quality livestock
              selection.
            </p>
          ...
          <div className="bg-white rounded-xl p-6 md:p-8 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col md:flex-row items-center md:items-start gap-8 relative overflow-hidden">
            ...
            <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left w-full z-10 mt-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-10 w-full mt-2">
                <div>
                  <div className="text-[11px] text-gray-500 font-bold uppercase tracking-widest mb-1.5">
                    Location
                  </div>
                ...
                <div>
                  ...
                  <div className="bg-[#fbbf24] text-amber-900 text-xs font-bold px-3.5 py-1 rounded-full inline-block shadow-sm">
                    Premium
                  </div>
                </div>
                <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="bg-white rounded-xl p-7 shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] border border-gray-100 h-full">
              <div className="flex justify-between items-center mb-7">
                ...
                <a
                  href="#"
                  className="text-sm font-bold text-[#b8860b] hover:text-[#9d740f] transition-colors"
                >
                  View All
                </a>
              </div>
              ...
              <div className="flex flex-col gap-7 relative">
                ...
                <div className="flex gap-4 relative z-10">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1 leading-relaxed">
                      Your reservation for &apos;Elite Brahman #402&apos; has
                ...
                <div className="flex gap-4 relative z-10">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1 leading-relaxed">
                      You&apos;ve saved &apos;Royal Camel Al-Zayid&apos; to your
                      watch list.
                    </p>
                    <div className="text-xs text-gray-400 font-medium mt-1.5">
                      Yesterday
                ...
                <div className="flex gap-4 relative z-10">
                  ...
                  <div className="pt-1">
                    ...
                    <p className="text-sm text-gray-600 mt-1 leading-relaxed">
                      Added AED 5,000 to your digital wallet for upcoming
                      auctions.
                    </p>
                    <div className="text-xs text-gray-400 font-medium mt-1.5">
                      3 days ago
            ...
            <div className="bg-[#0f4d30] rounded-xl overflow-hidden shadow-xl shadow-[#0f4d30]/20 flex flex-col relative text-white h-full">
              ...
              <div className="p-7 flex flex-col flex-1 relative z-10 -mt-2">
                ...
                <div className="mt-auto flex items-end justify-between border-t border-emerald-800/50 pt-5">
                  <div>
                    <div className="text-[10px] text-emerald-300 uppercase tracking-widest font-bold mb-1">
                      Current Bid
                    </div>
